...
export default function VoucherForm() {
  ...
  const onSubmit = (value) => {
    ...
    if (voucherId === 'create') createVoucher({ ...value, set_limit_amount: !!value.remain }, onSuccess, onFail);
    else updateVoucher(voucherId, { ...value, set_limit_amount: !!value.remain }, onSuccess, onFail);
  };
      ...
      >
        ...
        <Row className="p-10 pt-5 justify-between min-h-[465px]">
          ...
          <Col span={12}>
            ...
            >
              <Input
                placeholder={`Nhập giá trị bạn muốn giảm (${discountType ? '%' : 'đ'})`}
                autoComplete="false"
