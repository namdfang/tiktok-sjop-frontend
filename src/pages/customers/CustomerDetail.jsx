...
export default function CustomerDetail({ id }) {
  const { loadingById, customerById, getCustomerById } = useCustomersStore((state) => state);
      ...
      <>
        <Row className="items-center gap-[4px] justify-start mt-3 break-words flex-nowrap">
          <Col className="font-medium text-[#21409A]">
            <Image width={60} height={60} className="object-cover rounded-full" src={avatar_image || ImageDefault} />
          </Col>
        </Row>
        <Row className="items-center gap-[4px] justify-start mt-3 break-words flex-nowrap">
          <Col span={8}>Tên:</Col>
        ...
        <Row className="items-center gap-[4px] justify-start mt-3 break-words flex-nowrap">
          ...
          <Col className="font-medium text-[#21409A]">
            <p>{address_detail}</p>
            <p>
              {wards_name}, {district_name}, {province_name}, {country_name}
            </p>
          </Col>
        </Row>
        <Row className="items-center gap-[4px] justify-start mt-3 break-words flex-nowrap">
          ...
          <Col className="font-medium text-[#21409A]">
            {formatDate(new Date(created_at), ' HH:mm DD/MM/yyyy').toLocaleString()}
          </Col>
        </Row>
        <Row className="items-center gap-[4px] justify-start mt-3 break-words flex-nowrap">
